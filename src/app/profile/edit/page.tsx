...
export default function EditProfilePage() {
    ...
    const copy = locale === "vi-VN"
        ? {
            ...
            securityDescription: "Quản lý mật khẩu và bảo vệ tài khoản CardVerseHub của bạn.",
            password: "Mật khẩu",
        ...
        : locale === "ja-JP"
            ? {
                ...
                securityDescription: "パスワードとCardVerseHubアカウントの保護を管理します。",
                password: "パスワード",
            ...
            : {
                ...
                securityDescription: "Manage your password and protect your CardVerseHub account.",
                password: "Password",
