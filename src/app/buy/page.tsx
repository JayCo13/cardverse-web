...
export default async function BuyPage() {
    ...
    try {
        ...
        const { data, error } = await supabase
            .from('cards')
            .select('*, profiles:seller_id(display_name, profile_image_url, seller_verified, seller_review_count, shipping_carriers, shipping_fees, goship_tier_fees, reputation_score, reputation_incidents_90d, reputation_incidents_total, completed_transactions)')
