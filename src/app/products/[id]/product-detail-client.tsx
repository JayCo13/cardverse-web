...
const ProductHistoryChart = dynamic(() => import('@/components/ProductHistoryChart'), { ssr: false });
                    ...
                    <div className="space-y-6">
                        ...
                        {isVip ? (
                            <Card className="border-white/10">
                                ...
                                <CardContent>
                                    <div className="h-64">
                                        <ProductHistoryChart priceHistory={priceHistory} priceChange={priceChange} />
                                    </div>
                                </CardContent>
                            </Card>
                        ) : (
