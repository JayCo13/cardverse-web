...
**Parts 3 & 4 — unchanged:** the price section (incl. the USD/VND toggle + 10% withdrawal-fee notice
...
6. Regression: USD/VND toggle + confirm dialog + 10% withdrawal notice still work; bundles skip
   standardization.
